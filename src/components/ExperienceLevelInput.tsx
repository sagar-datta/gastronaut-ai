        ...
        >
          ...
          >
            <TabsList className="grid w-full grid-cols-3">
              <TabsTrigger
                value="beginner"
                className={cn("data-[state=active]:text-[#433633]", isLoading ? "disabled:cursor-not-allowed" : "")}
                disabled={isLoading}
              >
                Beginner Cook
              </TabsTrigger>
        ...
        >
          ...
          >
            ...
            <SelectContent>
              <SelectItem
                value="beginner"
                className={cn("font-medium text-[#433633]", isLoading ? "disabled:cursor-not-allowed" : "")}
              >
                Beginner Cook
              </SelectItem>
              <SelectItem
